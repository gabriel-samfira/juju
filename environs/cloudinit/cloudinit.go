...
type MachineConfig struct {
	...
	// Series represents the machines series. This is a convenience variable
	// that gets set at NewMachineConfig time, so we do not rely on the Tools
	// field being set just to find the series. Makes more sense that the Machine
	// should be aware of what series its supposed to be, even though the tools are
	// not set yet
	Series string
